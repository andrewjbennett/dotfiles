...
pwnable() { pw=$2; echo $pw;  sshpass -p ${pw:=guest} ssh $1@pwnable.kr -p2222; }

alias what="du -h -d1 | sort -h"

alias identify_digit="/home/andrew/src/tensorflow/bazel-bin/tensorflow/examples/label_image/label_image --graph=/tmp/output_graph.pb --labels=/tmp/output_labels.txt --output_layer=final_result  --input_layer=Mul"
